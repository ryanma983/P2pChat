...
public class KeyManager {
    ...
    public String getPrivateKeyFingerprint() {
        return getPublicKeyFingerprint(nodeKeyPair.getPublic());
    }
    
    /**
     * 获取所有会话密钥
     */
    public java.util.Map<String, javax.crypto.SecretKey> getAllSessionKeys() {
        return new java.util.HashMap<>(sessionKeys);
    }
    
    /**
     * 获取会话密钥的哈希值
     */
    public String getSessionKeyHash(String nodeId) {
        javax.crypto.SecretKey key = sessionKeys.get(nodeId);
